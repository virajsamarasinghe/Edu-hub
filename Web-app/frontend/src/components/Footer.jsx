    ...
    <div>
      <footer className="footer xl:px-24 py-10 px-4 text-base-content">
        <aside>
          ...
          Discover the path to knowledge and relish the achievement in every lesson at Edu-hub.
          </p>
        </aside> 
        <nav>
        ...
        <nav>
          ...
          <a className="link link-hover">info@edu-hub.com</a>
      ...
      <footer className="footer items-center xl:px-24 py-10 px-4  ">
        <aside className="items-center grid-flow-col"> 
          <p>Copyright © 2024 - All rights reserved by Edu-hub</p>
        </aside> 
