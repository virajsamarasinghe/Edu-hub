    ...
    useEffect(() => {
      ...
      const updatePhone = async () => {
        ...
        try {
          ...
          const response = await axios.post('http://192.168.1.12:5001/phone', {
            studentId,
            phone,
          });
      ...
      const updateFirstname = async () => {
        ...
        try {
          ...
          const response = await axios.post('http://192.168.1.12:5001/firstname', {
            studentId,
            firstName,
          });
      ...
      const updateLastname = async () => {
        ...
        try {
          ...
          const response = await axios.post('http://192.168.1.12:5001/lastname', {
            studentId,
            lastName,
          });
