...
export default function Home() {
        ...
        ({ item }: { item: Schedule }) => (
            ...
            <View
                ...
                <TouchableOpacity 
                    ...
                    style={styles.icons}
                >
                    <MaterialIcons name="delete-outline" size={24} color="#3f3f3f" />
                </TouchableOpacity>
                <Text
                    style={[
                        styles.line1Text,
    ...
    const handleSubmit = async () => {
        if (!title || !lesson || !location || !selectedDate || !selectedTime) {
    ...
    // Create handler for delete button press with confirmation
    const handleDeletePress = (scheduleId: string) => {
        Alert.alert(
            "Delete Schedule",
    ...
    return (
        ...
        >
            ...
            <TouchableOpacity style={styles.iconContainerb} onPress={openBottomSheet}>
            <FontAwesome6 name="add" size={30} color="#ffffff"   />
            </TouchableOpacity>
            ...
            >
                <View style={styles.bottomSheetContent}>
                    <Text style={styles.sheetTitle}>Add New Schedule</Text>
                     ...
                     <Text style={styles.label}>Lesson/Chapter</Text>
                     <View style={styles.inputContainer}>
                     <TextInput
                               // autoCapitalize="none"
                                value={lesson}
