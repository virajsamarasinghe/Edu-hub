...
export default function Profile() {
    ...
    useEffect(() => {
      ...
      const updatePhone = async () => {
        ...
        try {
          const emailAddress = await AsyncStorage.getItem('userT');
          if (!emailAddress) {
      ...
      const updateUsername = async () => {
        ...
        try {
          ...
          if (response.data && response.data.username) {
            ...
            // Store the updated phone number in AsyncStorage
            await AsyncStorage.setItem('usernameT', response.data.username);
          }
        ...
        const fetchPhoneFromDatabase = async () => {
          try {
            ...
            const response = await axios.get('http://192.168.8.142:5001/get-user-dataT', {
              ...
              await AsyncStorage.setItem('userT', emailAddress);
