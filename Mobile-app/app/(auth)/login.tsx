...
const Login = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const userDataResponse = await axios.get('http://172.20.10.2:5001/get-user-data', {
        params: { studentId }
      });
  ...
  const handleLoginP = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post('http://172.20.10.2:5001/loginP', {
        emailAddress,
        password1
      });
      setLoading(false);
      ...
      const userDataResponseP = await axios.get('http://172.20.10.2:5001/get-user-dataP', {
        params: { emailAddress}
      });
...
const handleLoginT = async () => {
  ...
  try {
    ...
    const response = await axios.post('http://172.20.10.2:5001/loginT', {
